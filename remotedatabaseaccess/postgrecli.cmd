             CMD        PROMPT('Postgres CLI Command Wrapper')
             PARM       KWD(SCRIPTFILE) TYPE(*CHAR) LEN(255) +
                          RSTD(*NO) MIN(1) MAX(1) CASE(*MIXED) +
                          PROMPT('Python script file')
             PARM       KWD(DBHOST) TYPE(*CHAR) LEN(100) RSTD(*NO) +
                          MIN(1) MAX(1) CASE(*MIXED) +
                          PROMPT('Database host or IP')
             PARM       KWD(DBNAME) TYPE(*CHAR) LEN(100) RSTD(*NO) +
                          MIN(1) MAX(1) CASE(*MIXED) +
                          PROMPT('Database name')
             PARM       KWD(DBUSER) TYPE(*CHAR) LEN(50) RSTD(*NO) +
                          MIN(1) MAX(1) CASE(*MIXED) +
                          PROMPT('Database user')
             PARM       KWD(DBPASS) TYPE(*CHAR) LEN(50) RSTD(*NO) +
                          MIN(1) MAX(1) CASE(*MIXED) +
                          PROMPT('Database password')
             PARM       KWD(DBPORT) TYPE(*CHAR) LEN(5) RSTD(*NO) +
                          MIN(1) MAX(1) CASE(*MIXED) +
