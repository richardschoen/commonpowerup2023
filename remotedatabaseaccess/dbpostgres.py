...
#-------------------------------------------------------
# Module: dbpostgres.py
# Desc: This module contains our Postres database class
#       for accessing PostgreSQL data.
#-------------------------------------------------------

#-------------------------------------------------------
# Class: DbPostgres
# Desc: This class is a wrapper class around Postgres database
# Driver: pip3 install psycopg2
#-------------------------------------------------------
...
class DbPostgres():
    ...
    def __init__(self,db_host,db_user,db_password,db_name,db_port):
        ...
        try:
           ...
           ##else:
              ##print("No PostgreSQL connection string passed in. Need to create connection later.")
    ...
    def create_connection(self,db_host,db_user,db_password,db_name,db_port):
        ...
        # Desc: Create a database connection to Postgres database
        # :param self: Pointer to object instance. 
