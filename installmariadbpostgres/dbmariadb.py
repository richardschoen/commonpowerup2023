...
#-------------------------------------------------------
# Module: dbmariadb.py
# Desc: This module contains our MySQL/MariaDB database class
#       for accessing MySQL/MariaDB data.
#-------------------------------------------------------

#-------------------------------------------------------
# Class: DbMariaDb
# Desc: This class is a wrapper class around MySQL/MariaDB database
# Uses this driver: https://pypi.org/project/PyMySQL/
# Note: pip3 install mariadb driver does not work. 
#-------------------------------------------------------
...
class DbMariaDb():
    ...
    def __init__(self,db_host,db_user,db_password,db_name,db_port):
        ...
        try:
           ...
           self.create_connection(db_host,db_user,db_password,db_name,db_port)
           ##else:
              ##print("No MariaDB connection string passed in. Need to create connection later.")
    ...
    def create_connection(self,db_host,db_user,db_password,db_name,db_port):
        #-------------------------------------------------------
        ...
        #Let's try and open the database. 
        try:
    ...
    def execute(self,sql):
        ...
        try:
            ...
            cursor1.execute(sql) #Execute the action query
            # PyMySql connection not auto-commit by default 
            # so we must commit
            conn1.commit()
            return True
        except Exception as e:
    ...
    def query_qcustcdt(self,wherestmt):
        #----------------------------------------------------------
